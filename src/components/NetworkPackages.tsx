...
const allPackages = [
  { price: "Ksh 5", duration: "2 Hours", type: "Limited" },
  { price: "Ksh 10", duration: "6 Hours", type: "Limited" },
  { price: "Ksh 15", duration: "8 Hours", type: "Limited" },
  { price: "Ksh 20", duration: "1 Day", type: "Limited" },
  { price: "Ksh 25", duration: "1 Day 6 Hours", type: "Unlimited" },
  { price: "Ksh 30", duration: "2 Days", type: "Unlimited" },
  { price: "Ksh 50", duration: "3 Days", type: "Unlimited" },
...
>
  ...
  <div className="relative z-10 text-center mb-12 max-w-3xl mx-auto">
    ...
    <p className="text-lg text-gray-300 flex md:pl-46 mx-auto">
      ...
      <Card className="relative z-10 max-w-6xl mx-auto w-full bg-white/5 backdrop-blur-md border border-white/20 p-6 rounded-2xl shadow-lg">
        ...
        {/* Package Cards */}
        <CardContent className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-6">
